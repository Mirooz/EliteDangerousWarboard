...
/**
 * Toast affiché après réception du callback OAuth Frontier par le backend.
 * Auto-ferme après {@link #DISPLAY_DURATION}.
 */
public class CapiAuthConnectedNotificationComponent extends VBox {
    ...
    public CapiAuthConnectedNotificationComponent(StackPane container) {
        ...
        this.getStyleClass().add("capi-auth-connected-notification");
        ...
        Label title = new Label(localizationService.getString("capi.auth.connected"));
        title.getStyleClass().add("capi-auth-connected-title");
